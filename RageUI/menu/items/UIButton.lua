        ...
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if (Enabled) then
                    ...
                    elseif Selected and (Hovered and CurrentMenu.Controls.RightClick.Pressed) then
                        if(Callback.onRightClick ~= nil) then
                            Callback.onRightClick();
                            CurrentMenu.Controls.RightClick.Pressed = false
                        end
