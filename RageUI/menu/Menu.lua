...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Title = string.upper(Title) or ""
    Menu.TitleFont = 4
    Menu.TitleScale = 1.2
...
function RageUI.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUI.CreateMenu(Title or ParentMenu.Title, "~y~".. string.upper(Subtitle) or "~y~".. string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
